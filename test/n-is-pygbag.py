    ...
    try:
        ...
        if selected_music == 'korobeiniki - piano':
            music_file = os.path.join(
                music_folder, "tetris-theme-korobeiniki-arranged-for-piano-186249.ogg")
            vol = 0.7
        elif selected_music == 'korobeiniki - music box':
            music_file = os.path.join(
                music_folder, "tetris-theme-korobeiniki-rearranged-arr-for-music-box-184978.ogg")
            vol = 0.3
        elif selected_music == 'korobeiniki - strings':
            music_file = os.path.join(
                music_folder, "tetris-theme-korobeiniki-rearranged-arr-for-strings-185592.ogg")
            vol = 0.5
        else:
            music_file = os.path.join(
...
def toggle_all_sound():
    ...
    if sound_on:
        ...
        music_file = os.path.join(os.path.dirname(__file__), "music.ogg")
        if os.path.exists(music_file):
            try:
